...
write.table(x = dataForPathPlotting_plotly, file = "C:/Users/Geoffrey House User/Documents/GitHub/MN_cropRotations/imgData/state/MN_forPlotly_lines.csv", sep = ",", row.names = FALSE)
